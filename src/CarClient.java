...
public class CarClient extends spriteCharacteristics {
	...
	public CarClient (int x, int y, int width, int height, String image, Boolean moving, int speed, Boolean moveLeft) {
