...
public class FroggerClient extends JFrame implements KeyListener, ActionListener {
	...
	public FroggerClient() {
		...
		gameCharacter = new gameCharacter(240,870,100,100,"Frog.png");
	...
	public static void main(String[] args) throws IOException {
		...
		Thread t1 = new Thread ( new Runnable () {
			public void run ( ) {
				...
				//trying to make it so Frog starts in right spot instead of getting sent right into the water the moment the game starts
				boolean initialized = false;	
					...
					try {
						...
						while(true) {
							...
							try {
								s2 = client.accept();
								FroggerClientService myService = new FroggerClientService (s2, myGame.gameCharacter, myGame.frogLabel);
