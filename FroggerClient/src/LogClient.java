...
public class LogClient extends spriteCharacteristics implements Runnable {
	...
	public LogClient (int x, int y, int width, int height, String image, Boolean moving, int speed, Boolean moveLeft) {
